...
export function ProductDetailsPage() {
  ...
  if (detailsStatus === 'failed') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-rose-500">
        ...
        <p className="text-gray-400 mt-2">{error || 'Data packet lost during transmission.'}</p>
        <button 
  ...
  return (
    ...
    >
      <button 
        onClick={() => navigate('/products')}
        className="flex items-center gap-2 text-gray-400 hover:text-primary-400 transition-colors font-mono text-sm group"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          <Card className="p-4 bg-white/5 border-white/5 overflow-hidden group" hover={false}>
            {isLoading ? (
              ...
              selectedProduct.images.slice(0, 4).map((img, idx) => (
                <button 
                  ...
                  className={`relative h-24 rounded-2xl overflow-hidden border-2 transition-all ${
                    activeImage === img ? 'border-primary-500 shadow-glow-purple' : 'border-white/5 hover:border-white/20'
                  }`}
                >
          ...
          <div className="space-y-4">
            {isLoading ? (
              ...
              <>
                ...
                <h1 className="text-4xl font-bold text-white glow-text tracking-tight leading-tight">
             ...
             {isLoading ? (
               ...
               <div className="flex items-end justify-between relative z-10">
                 <div className="flex flex-col">
                   ...
                   <div className="flex items-center gap-3">
                     <span className="text-5xl font-bold text-white font-mono">${selectedProduct.price}</span>
                 ...
                 <div className="flex flex-col items-end">
                   ...
                   <span className="text-[10px] font-mono text-gray-500 uppercase">Customer Confidence</span>
                 </div>
               </div>
             )}
             {/* Decorative pattern */}
      ...
      {/* Extended Details */}
      {!isLoading && (
        <Card className="p-10 border-white/5 mt-10" hover={false}>
